...
testParseRepl = do
  ...
  case ast of
    ReplStmt (ParsedStmt _ (ParsedDeclStmt (ParsedValueDecl Mutable _ (Just (TypeSyntax _ (IntSyntax _ _))) (Just (ParsedExpr _ (ParsedIntLit 42)))))) -> return ()
  ...
  case ast3 of
    ReplExpr (ParsedExpr _ (ParsedBinaryExpr AddOp (ParsedExpr _ (ParsedIntLit 1)) (ParsedExpr _ (ParsedIntLit 2)))) -> return ()
  ...
  ast4 <-
    assertRight "repl: expression with semicolon" $
      runAlex "1 + 2;" parseRepl
  case ast4 of
    ReplStmt (ParsedStmt _ (ParsedExprStmt (ParsedExpr _ (ParsedBinaryExpr AddOp (ParsedExpr _ (ParsedIntLit 1)) (ParsedExpr _ (ParsedIntLit 2)))))) -> return ()
  ...
  ast5 <-
    assertRight "repl: variable reference" $
      runAlex "x" parseRepl
  case ast5 of
    ReplExpr (ParsedExpr _ (ParsedVarExpr (Ident _ "x"))) -> return ()
  ...
  case ast6 of
    ReplExpr (ParsedExpr _ (ParsedBinaryExpr AddOp (ParsedExpr _ (ParsedVarExpr (Ident _ "x"))) (ParsedExpr _ (ParsedIntLit 1)))) -> return ()
