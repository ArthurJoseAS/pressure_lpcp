{
module Pressure.Language.Parser (parseRepl, parseProgram, genAst, parseErrorInfo) where
...
toBuiltinIdent :: Token -> Ident
toBuiltinIdent (BuiltinId pos name) = Ident pos ('@' : name)
toBuiltinIdent _ = error "internal parser error: expected builtin identifier"
...
toStringLit :: Token -> ParsedExpr
toStringLit (StringLiteral pos value) = ParsedExpr pos (ParsedStringLit value)
